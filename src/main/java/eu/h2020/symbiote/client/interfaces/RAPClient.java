...
public interface RAPClient {
    ...
    /**
     * Get the latest top observations by query
     *
     * @param resourceUrl      the resource url
     * @param top              the number of observations
     * @param from_date        start date query rules for observations
     * @param to_date          end date query rules for observations
     * @param serverValidation if true it will validate RAP
     * @param homePlatformIds  a set of home platform ids from which we are going to get credentials for the request
     * @return a list of {@link Observation}
     */
    List<Observation> getObservationsByQuery(String resourceUrl, int top, String from_date, String to_date, boolean serverValidation, Set<String> homePlatformIds);
